...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("CREATING: web server on port 8081 [modified]");
		Server server = launcher.launch(true, 8081, warFile.getAbsolutePath(), "/lab02");

        // Start things up!		
		System.out.println("STARTING: web server on port 8081[modified]");
		server.start();
		...
		System.out.println("RUNNING: web server on port 8081[modified]");
